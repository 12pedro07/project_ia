...
class Cell:
    def __init__(self,i,j,base,altura,ID):
        # Caracteristics
        self.id = ID
        self.base = base
        self.altura = altura
        ...
        self.h = math.inf # cost to move from that given square on the grid to the final destination
        self.f = math.inf # g + h
        self.parent = None
    ...
    def show_id(self,img):
        ...
        cv2.putText(img,str(self.g),self.botton_left, font, 0.5,(255,255,255),1,cv2.LINE_AA)
